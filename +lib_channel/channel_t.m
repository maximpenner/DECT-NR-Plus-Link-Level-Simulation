classdef channel_t < handle
    ...
    methods (Static = true, Access = public)
       ...
       function obj = channel_t(config)
            assert(isa(config, "lib_channel.config_t"));
    ...
    methods
        function init_Rayleigh_Rician_channel(obj)
            ...
            % lookup PDP
            [pathDelays_beforeInterpolation, avgPathGains_beforeInterpolation] = lib_channel.get_PDP_from_literature(obj.config.r_type, ...
