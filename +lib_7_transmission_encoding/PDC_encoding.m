function [x_PDC, pdc_enc_dbg] = PDC_encoding(tb_bits, ...
    ...
    if Z == 2048
        c = lib_6_generic_procedures.lib_cc_rm_i.code_block_segmentation(b);
    elseif Z == 6144
...
function [] = assert_segmentation(B, Z, c)
    ...
    K_r = lib_6_generic_procedures.lib_cc_rm_i.get_3gpp_code_block_segment_lengths(B, Z);
...
function [] = assert_ratematching(c, G, f, Q_m)
    ...
    E_r = lib_6_generic_procedures.lib_cc_rm_i.get_3gpp_encoded_code_block_segment_lengths(G, C, N_L, Q_m);
