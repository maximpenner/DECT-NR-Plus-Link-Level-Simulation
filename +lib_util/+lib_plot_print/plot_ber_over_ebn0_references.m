function [] = plot_ber_over_ebn0_references(mcs_index, snr_db_vec, bps, tbs, colors, K)
    ...
    semilogy(EbN0_dB_vec, ber_rayleigh,'-','DisplayName',str, 'Color', colors);
    hold on
        ...
        hold on
            ...
            hold on
                ...
                semilogy(EbN0_dB_vec, ber_rayleigh,'-o','DisplayName',str, 'Color', colors);
                hold on
                    ...
                    semilogy(EbN0_dB_vec, ber_rayleigh,'-d','DisplayName',str, 'Color', colors);
                    hold on
end