function [] = plot_resource_mapping(numerology, ...
                                    N_PACKET_symb, ...
                                    N_TS, ...
                                    N_SS, ...
    ...
    % create matrix
    [mat_STF_DRS_PCC_PDC, mat_STF_DRS_PCC_PDC_all_streams] = lib_util.matrix_STF_DRS_PCC_PDC(N_b_DFT, ...
                                                                                             N_PACKET_symb, ...
                                                                                             N_TS, ...
                                                                                             N_SS, ...
                                                                                             physical_resource_mapping_STF_cell, ...
    ...
    assert(1+N_TS+1+N_SS == numel(mat_STF_DRS_PCC_PDC));
