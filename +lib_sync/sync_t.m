classdef sync_t < matlab.mixin.Copyable
    ...
    methods
        ...
        function [samples_antenna_rx] = synchronize(obj, samples_antenna_ch)
            ...
            if obj.config.oversampling > 1
                samples_antenna_ch = lib_sync.lpf(samples_antenna_ch, obj.config.oversampling);
            end
        
            %% detection by searching for a coarse metric threshold crossing
        
            coarse_metric_threshold_crossing_idx = lib_sync.detection(obj.detection_threshold_step, ...
            ...
            coarse_peak_idx = lib_sync.coarse_peak_search(obj.config.verbosity, ...
                                                          obj.detection_minimum_power_threshold, ...
                                                          obj.detection_threshold_value, ...
            ...
            if obj.cfo_fractional_enable == true
                [samples_antenna_stf_at_coarse_peak_cfo_fractional, cfo_fractional_report] = lib_sync.cfo_fractional(samples_antenna_stf_at_coarse_peak, ...
                                                                                                                     obj.n_samples_STF_b_os, ...
                                                                                                                     obj.config.u);
            else
            ...
            if obj.cfo_integer_enable == true
                cfo_integer_report = lib_sync.cfo_integer(obj.cfo_integer_candidate_values, ...
            ...
            [N_eff_TX_report, max_idx_fine] = lib_sync.fine_peak_search(obj.config.verbosity, ...
                                                                        obj.config.oversampling, ...
                                                                        obj.derived.numerology.N_b_DFT, ...
                                                                        coarse_peak_idx, ...
    ...
    methods (Hidden = true)
        function obj = set_example_values(obj)
            ...
            obj.stf_templates = lib_rx.stf_templates(obj.config);
            ...
            obj.cfo_integer_max_deviation_subcarrier_spacings = lib_sync.cfo_max(obj.config.u);
