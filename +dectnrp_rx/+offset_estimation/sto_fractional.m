function [antenna_streams_mapped_rev_derot, sto_fractional] = sto_fractional(antenna_streams_mapped_rev, ...
    ...
    STF_k_i_matlab  = dectnrp_util.index_conversion_TS_matlab(N_b_DFT, cell2mat(physical_resource_mapping_STF_cell(1)));
