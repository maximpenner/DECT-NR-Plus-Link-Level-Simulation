    ...
    methods
        ...
        function [plcf_bits_recovered, tb_bits_recovered] = demod_decode_packet(obj, samples_antenna_rx)
            ...
            if ~isempty(obj.rx_config.sto_fractional_config)
                [antenna_streams_mapped_rev, sto_fractional] = dectnrp_rx.offset_estimation.sto_fractional(antenna_streams_mapped_rev, ...
            ...
            if ~isempty(obj.rx_config.sto_residual_config)
                [antenna_streams_mapped_rev, sto_residual] = dectnrp_rx.offset_estimation.sto_residual(antenna_streams_mapped_rev, ...
            ...
            if ~isempty(obj.rx_config.cfo_residual_config)
                antenna_streams_mapped_rev = dectnrp_rx.offset_estimation.cfo_residual(antenna_streams_mapped_rev, ...
                                                                                       physical_resource_mapping_DRS_cell, ...
                                                                                       physical_resource_mapping_STF_cell, ...
                                                                                       obj.rx_config.N_RX, ...
                                                                                       N_eff_TX);
