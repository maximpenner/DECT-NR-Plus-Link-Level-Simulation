function [noise_power] = noise_estimation(antenna_streams_mapped_rev, ...
                                          ...
                                          N_RX, ...
                                          N_eff_TX)
    % We can use the channel estimate to estimate the noise power.
    % This estimation is needed for the MIMO feedback as suggested in https://ieeexplore.ieee.org/document/8059870
